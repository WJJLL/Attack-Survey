...
def main():
    ...
    # args.num_iterations = math.ceil(len(data_train) / args.batch_size) * args.num_epochs
    ...
    elif args.loss_function == "cos_sim":
        criterion = CosSimLoss()
    elif args.loss_function == "r_ce":
        criterion = RelativeCrossEntropy()
    elif args.loss_function == "cell":
        criterion = CrossEntropyLeastLikely()
    elif args.loss_function == "feature_layers":
        criterion = FeatureLayer()

    ##targeted_loss##
    if args.loss_function == "ce":
        criterion = torch.nn.CrossEntropyLoss()
    elif args.loss_function == "bounded_logit_fixed_ref":
        criterion = BoundedLogitLossFixedRef(num_classes=num_classes, confidence=args.confidence,
                                             use_cuda=args.use_cuda)
    elif args.loss_function == "t_r_ce":
        criterion = TargetRelativeCrossEntropy()
