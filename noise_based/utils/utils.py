...
def get_result_path(dataset_name, network_arch, random_seed, result_subfolder, postfix=''):
    ...
    # result_path = os.path.join(RESULT_PATH, result_subfolder, "{}_{}_{}_{}_{}"
    #                            .format(t_string, dataset_name, network_arch, random_seed, postfix))
    result_path = os.path.join(RESULT_PATH, result_subfolder, "{}_{}_{}_{}"
                               .format(dataset_name, network_arch, random_seed, postfix))
